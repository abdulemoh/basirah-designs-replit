          ...
          <div className="relative bg-[#F5F0E8] p-8 md:p-12 border border-[#E5DDD0] rounded-xl">
            ...
            <div className="text-center mb-10">
              ...
              <p className="text-[#7A6E62] text-sm font-body">
                <span className="text-xs">A clean website consisting of 5-10 pages that displays business info,  contact emails, and FAQs, already set up and handled for you. Includes a default maintenance plan that takes care of hosting your website, fixing bugs, performing requested changes, etc.</span>
              </p>
            </div>
