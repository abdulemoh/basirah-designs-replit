...
export default function PricingSection() {
 ...
 <p className="text-[#B8973A] text-[10px] tracking-[0.4em] uppercase font-body mb-6">THE ONE PAGE

 </p>
 <h2 className="font-body text-4xl md:text-5xl text-[#1C1810] italic font-light mb-2">
 <span className="outline-none">Standard Plan</span>
 </h2>
 <p className="text-[#7A6E62] text-sm font-body">
 <span className="outline-none text-xs">A clean website consisting of 1-2 pages that displays business info and contact emails, already set up and handled for you. Includes a default maintenance plan that takes care of hosting your website, fixing bugs, performing requested changes, etc.</span>
 </p>
 </div>
 ...
 {/* Pricing blocks */}
 <div className="grid grid-cols-1 md:grid-cols-2 gap-4 md:gap-6 mb-10 items-stretch">
 <div className="text-center p-4 border border-[#DDD4C0] rounded-sm bg-[#FAF7F2] flex flex-col justify-between">
 <p className="text-[#7A6E62] text-[9px] tracking-[0.3em] uppercase mb-3 font-body text-center px-5">STANDARD FEE
 ...
 <p className="text-[#7A6E62] text-[9px] tracking-[0.3em] uppercase mb-3 font-body">Monthly Maintenance
 ...
 <span className="text-[#1C1810] text-sm font-body font-light outline-none">{feature}</span>
 </motion.li>
 )}
 </ul>
 ...
 className="w-full py-4 bg-[#B8973A] text-[#FAF7F2] text-sm font-semibold tracking-[0.2em] uppercase hover:bg-[#a5862f] transition-colors duration-300 focus:outline-none focus:ring-2 focus:ring-[#B8973A] focus:ring-offset-2 focus:ring-offset-[#FAF7F2] min-h-[48px] rounded-[10px]">
